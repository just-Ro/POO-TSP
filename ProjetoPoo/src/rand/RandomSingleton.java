...
/**
 * <p>The RandomSingleton class implements the singleton pattern to provide a single instance of the CustomRandom class.
 ...
 * 
 * <p>This class is designed to be used as a singleton, meaning that only one instance should be created throughout the application.
 * The getInstance() method is used to obtain the singleton instance of CustomRandom.</p>
 * 
 * <p>Example usage:</p>
 * <pre>{@code
